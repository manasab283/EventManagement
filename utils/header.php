        ...
        <div class="container">
            ...
            <ul class="nav navbar-nav navbar-right"><!--navigation-->
                ...
                if(is_logged_in()){
                    ...
                    echo '<li><a href = "viewDecorators.php">Decorators</a></li>';
                    echo '<li><a href = "viewCaterers.php">Caterers</a></li>';
                    echo '<li><a href = "viewBookings.php">Bookings</a></li>';
                    echo '<li><a href = "viewFeedback.php">Feedback</a></li>';
                ...
                //links non database contents. *if logged out
                    ...
                    echo '<li><a href = "decorator.php">Decorators</a></li>';
                    echo '<li><a href = "caterer.php">Caterers</a></li>';
