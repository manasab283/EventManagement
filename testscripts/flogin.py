...
def test_login():
    try:
        ...
        driver.find_element_by_xpath('/html/body/header/nav/div/ul/div/div/div/div[2]/div/div/form/div[2]/input').send_keys('man')
        sleep(2)
        login_xpath = "/html/body/header/nav/div/ul/div/div/div/div[2]/div/div/form/button"
        login_button = driver.find_element_by_xpath(login_xpath)
        login_button.click()

        home_xpath = "/html/body/header/nav/div/ul/li[6]/a"
        home_button = driver.find_element_by_xpath(home_xpath)
        home_button_text = 'Bookings'
        assert home_button_text == home_button.text
        home_button.click()
